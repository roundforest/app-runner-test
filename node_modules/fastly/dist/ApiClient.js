  ...
  */
  _createClass(ApiClient, [{
    ...
    */
     ...
     */
    function buildUrl(path, pathParams, pathParamsAllowReserved, apiBasePath) {
      var _this = this;
      if (!path.match(/^\//)) {
        path = '/' + path;
      }
    ...
    */
    ...
    key: "callApi",
    value: function callApi(path, httpMethod, pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, bodyParam, authNames, contentTypes, accepts, returnType, apiBasePath) {
      var _this3 = this;
