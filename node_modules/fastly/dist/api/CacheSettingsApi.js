  ...
  */
  ...
  _createClass(CacheSettingsApi, [{
    ...
    value: function createCacheSettingsWithHttpInfo() {
      ...
      return this.apiClient.callApi('/service/{service_id}/version/{version_id}/cache_settings', 'POST', pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function deleteCacheSettingsWithHttpInfo() {
      ...
      return this.apiClient.callApi('/service/{service_id}/version/{version_id}/cache_settings/{cache_settings_name}', 'DELETE', pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function getCacheSettingsWithHttpInfo() {
      ...
      var accepts = ['application/json'];
      var returnType = _CacheSettingResponse["default"];
      return this.apiClient.callApi('/service/{service_id}/version/{version_id}/cache_settings/{cache_settings_name}', 'GET', pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function listCacheSettingsWithHttpInfo() {
      ...
      var accepts = ['application/json'];
      var returnType = [_CacheSettingResponse["default"]];
      return this.apiClient.callApi('/service/{service_id}/version/{version_id}/cache_settings', 'GET', pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function updateCacheSettingsWithHttpInfo() {
      ...
      var accepts = ['application/json'];
      var returnType = _CacheSettingResponse["default"];
      return this.apiClient.callApi('/service/{service_id}/version/{version_id}/cache_settings/{cache_settings_name}', 'PUT', pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
