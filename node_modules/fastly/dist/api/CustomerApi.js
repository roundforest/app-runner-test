  ...
  */
  ...
  _createClass(CustomerApi, [{
    ...
    value: function deleteCustomerWithHttpInfo() {
      ...
      return this.apiClient.callApi('/customer/{customer_id}', 'DELETE', pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function getCustomerWithHttpInfo() {
      ...
      return this.apiClient.callApi('/customer/{customer_id}', 'GET', pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function getLoggedInCustomerWithHttpInfo() {
      ...
      var accepts = ['application/json'];
      var returnType = _CustomerResponse["default"];
      return this.apiClient.callApi('/current_customer', 'GET', pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function listUsersWithHttpInfo() {
      ...
      return this.apiClient.callApi('/customer/{customer_id}/users', 'GET', pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function updateCustomerWithHttpInfo() {
      ...
      var accepts = ['application/json'];
      var returnType = _CustomerResponse["default"];
      return this.apiClient.callApi('/customer/{customer_id}', 'PUT', pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
