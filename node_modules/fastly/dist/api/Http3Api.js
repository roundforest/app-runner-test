  ...
  */
  ...
  _createClass(Http3Api, [{
    ...
    value: function createHttp3WithHttpInfo() {
      ...
      return this.apiClient.callApi('/service/{service_id}/version/{version_id}/http3', 'POST', pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function deleteHttp3WithHttpInfo() {
      ...
      return this.apiClient.callApi('/service/{service_id}/version/{version_id}/http3', 'DELETE', pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function getHttp3WithHttpInfo() {
      ...
      var accepts = ['application/json'];
      var returnType = _Http["default"];
      return this.apiClient.callApi('/service/{service_id}/version/{version_id}/http3', 'GET', pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
