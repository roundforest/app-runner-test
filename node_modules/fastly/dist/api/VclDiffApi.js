  ...
  */
  ...
  _createClass(VclDiffApi, [{
    ...
    value: function vclDiffServiceVersionsWithHttpInfo() {
      ...
      return this.apiClient.callApi('/service/{service_id}/vcl/diff/from/{from_version_id}/to/{to_version_id}', 'GET', pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
