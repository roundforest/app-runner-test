...
var _BulkUpdateConfigStoreItem = _interopRequireDefault(require("./BulkUpdateConfigStoreItem"));
 ...
 * @version 4.1.1
 */
var BulkUpdateConfigStoreListRequest = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>BulkUpdateConfigStoreListRequest</code>.
   * @alias module:model/BulkUpdateConfigStoreListRequest
   */
  function BulkUpdateConfigStoreListRequest() {
    _classCallCheck(this, BulkUpdateConfigStoreListRequest);
   ...
   */
  _createClass(BulkUpdateConfigStoreListRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('items')) {
          obj['items'] = _ApiClient["default"].convertToType(data['items'], [_BulkUpdateConfigStoreItem["default"]]);
        }
      }
      return obj;
    }
  }]);
  return BulkUpdateConfigStoreListRequest;
}();
/**
 * @member {Array.<module:model/BulkUpdateConfigStoreItem>} items
 */
BulkUpdateConfigStoreListRequest.prototype['items'] = undefined;
var _default = BulkUpdateConfigStoreListRequest;
