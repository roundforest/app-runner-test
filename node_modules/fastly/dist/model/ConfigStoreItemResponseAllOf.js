 ...
 * @version 4.1.1
 */
var ConfigStoreItemResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ConfigStoreItemResponseAllOf</code>.
   * @alias module:model/ConfigStoreItemResponseAllOf
   */
  function ConfigStoreItemResponseAllOf() {
    _classCallCheck(this, ConfigStoreItemResponseAllOf);
   ...
   */
  _createClass(ConfigStoreItemResponseAllOf, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('store_id')) {
          obj['store_id'] = _ApiClient["default"].convertToType(data['store_id'], 'String');
        }
      }
      return obj;
    }
  }]);
  return ConfigStoreItemResponseAllOf;
}();
/**
 * @member {String} store_id
 */
ConfigStoreItemResponseAllOf.prototype['store_id'] = undefined;
var _default = ConfigStoreItemResponseAllOf;
