 ...
 * @version 4.1.1
 */
var EnabledProductResponseProduct = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>EnabledProductResponseProduct</code>.
   * @alias module:model/EnabledProductResponseProduct
   */
  function EnabledProductResponseProduct() {
    _classCallCheck(this, EnabledProductResponseProduct);
   ...
   */
  _createClass(EnabledProductResponseProduct, null, [{
    key: "initialize",
  ...
  return EnabledProductResponseProduct;
}();
/**
 * Product identifier
 * @member {String} id
...
var _default = EnabledProductResponseProduct;
