 ...
 * @version 4.1.1
 */
var EnabledProductResponseService = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>EnabledProductResponseService</code>.
   * @alias module:model/EnabledProductResponseService
   */
  function EnabledProductResponseService() {
    _classCallCheck(this, EnabledProductResponseService);
   ...
   */
  _createClass(EnabledProductResponseService, null, [{
    key: "initialize",
  ...
  return EnabledProductResponseService;
}();
/**
 * Service identifier
 * @member {String} id
...
var _default = EnabledProductResponseService;
