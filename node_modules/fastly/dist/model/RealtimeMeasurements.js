    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('object_store_class_a_operations')) {
          obj['object_store_class_a_operations'] = _ApiClient["default"].convertToType(data['object_store_class_a_operations'], 'Number');
        }
        if (data.hasOwnProperty('object_store_class_b_operations')) {
          obj['object_store_class_b_operations'] = _ApiClient["default"].convertToType(data['object_store_class_b_operations'], 'Number');
        }
        ...
        if (data.hasOwnProperty('ddos_action_limit_streams_connections')) {
          obj['ddos_action_limit_streams_connections'] = _ApiClient["default"].convertToType(data['ddos_action_limit_streams_connections'], 'Number');
        }
        if (data.hasOwnProperty('ddos_action_limit_streams_requests')) {
          obj['ddos_action_limit_streams_requests'] = _ApiClient["default"].convertToType(data['ddos_action_limit_streams_requests'], 'Number');
        }
        if (data.hasOwnProperty('ddos_action_tarpit_accept')) {
          obj['ddos_action_tarpit_accept'] = _ApiClient["default"].convertToType(data['ddos_action_tarpit_accept'], 'Number');
        }
        if (data.hasOwnProperty('ddos_action_tarpit')) {
          obj['ddos_action_tarpit'] = _ApiClient["default"].convertToType(data['ddos_action_tarpit'], 'Number');
        }
        if (data.hasOwnProperty('ddos_action_close')) {
          obj['ddos_action_close'] = _ApiClient["default"].convertToType(data['ddos_action_close'], 'Number');
        }
        if (data.hasOwnProperty('ddos_action_blackhole')) {
          obj['ddos_action_blackhole'] = _ApiClient["default"].convertToType(data['ddos_action_blackhole'], 'Number');
        }
      }
      return obj;
    }
